  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(79, 70, 229, 0.2), 0 0 10px rgba(79, 70, 229, 0.2), 0 0 15px rgba(79, 70, 229, 0.2)' },
          '100%': { boxShadow: '0 0 10px rgba(79, 70, 229, 0.4), 0 0 20px rgba(79, 70, 229, 0.4), 0 0 30px rgba(79, 70, 229, 0.4)' },
        },
        float: {
      ...
      backgroundImage: {
        ...
        'gradient-aurora': 'linear-gradient(45deg, #00f5ff, #fc00ff, #fffc00, #00f5ff)',
